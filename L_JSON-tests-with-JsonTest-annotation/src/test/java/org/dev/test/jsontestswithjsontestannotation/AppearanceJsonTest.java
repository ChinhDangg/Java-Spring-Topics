...
import org.dev.test.jsontestswithjsontestannotation.Model.Appearance;
...
@JsonTest // isolation test - doesnt need whole application to start up
          // - the controller is not in the application context for this test
class AppearanceJsonTest {
    ...
    @Test
    void testSerializationWihtJsonFile() throws IOException {
        ...
        JsonContent<Appearance> json = jacksonTester.write(appearance);
        assertThat(json).isEqualToJson(new ClassPathResource("appearance.json")); // assert with a json file

        assertThat(json).isEqualToJson(getAppearanceJson()); // assert with json string return
    }
    ...
    @Test
    void testListAppearanceSerialization() throws IOException {
        ...
        assertThat(json).isEqualToJson(appearanceJsonContent); // cant use @Value annotation for class path
    }

    @Value("classpath:appearances.json")
    ...
    void testDeserialization() throws IOException {
        ...
        assertThat(appearance.getStartDate()).isEqualTo(LocalDate.of(2022,4,26));
        assertThat(appearance.getEndDate()).isEqualTo(LocalDate.of(2022,4,27));
